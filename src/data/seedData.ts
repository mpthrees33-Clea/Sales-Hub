...
export const seedProjects: (Project & ProjectExtensions)[] = [
  ...
  // ── Recent activity for the Dashboard metrics ──
  // Adds real activity in the current week (May 10–12) and this month
  // (May 2026) so Sales Created + Invoiced cards show plausible numbers
  // instead of zeros. Three closed/invoiced + two newly created.
  {
    id: 'pr39', customerId: 'c4', name: 'Kim Floors Sandy Springs Satellite — phase 1', status: 'Won',
    description: 'Sandra opened her second satellite — phase-1 install completed this week',
    address: '5775 Glenridge Dr, Sandy Springs, GA 30328',
    value: 28500, productIds: ['p1', 'p3'], sampleOrderIds: [],
    notes: [],
    createdDate: '2026-03-28', anticipatedOrderDate: '2026-05-08', closingDate: '2026-05-08',
    invoicedDate: '2026-05-08', invoicedAmount: 28500,
    opportunityId: 'OPP-2026-0089', salesRepId: 'rep-sarah', salesLocationId: '310',
    projectType: 'retail', opportunityStatus: 'won', opportunityStage: 'orders_placed',
    nextStep: 'Confirm install completion + collect punch list',
    updatedDate: '2026-05-08', endUserCustomerId: 'c4', jobLocation: 'Sandy Springs, GA',
    bidders: [],
    lastTouchAt: '2026-05-08T16:00:00Z',
  },
  {
    id: 'pr40', customerId: 'c6', name: 'Augusta Riverwalk Condos — Phase I delivery', status: 'Won',
    description: 'Phase 1 of the riverwalk condos shipped this week — 60 of 132 units',
    address: '1 10th St, Augusta, GA 30901',
    value: 92000, productIds: ['p1', 'p3'], sampleOrderIds: [],
    notes: [],
    createdDate: '2026-03-02', anticipatedOrderDate: '2026-05-10', closingDate: '2026-05-10',
    invoicedDate: '2026-05-11', invoicedAmount: 92000,
    opportunityId: 'OPP-2026-0072', salesRepId: 'rep-sarah', salesLocationId: '310',
    projectType: 'multifamily', opportunityStatus: 'won', opportunityStage: 'orders_placed',
    nextStep: 'Phase 2 PO expected end of May',
    updatedDate: '2026-05-11', architecturalFirmId: 'c6', jobLocation: 'Augusta, GA',
    bidders: [],
    lastTouchAt: '2026-05-11T09:30:00Z',
  },
  {
    id: 'pr41', customerId: 'c7', name: 'Macon Medical Suite C remodel', status: 'Won',
    description: 'Small remodel — completed and invoiced late April',
    address: '600 Professional Blvd, Macon, GA 31210',
    value: 18000, productIds: ['p8'], sampleOrderIds: [],
    notes: [],
    createdDate: '2026-02-12', anticipatedOrderDate: '2026-04-22', closingDate: '2026-04-22',
    invoicedDate: '2026-04-28', invoicedAmount: 18000,
    opportunityId: 'OPP-2026-0055', salesRepId: 'rep-sarah', salesLocationId: '310',
    projectType: 'healthcare', opportunityStatus: 'won', opportunityStage: 'orders_placed',
    nextStep: 'Confirm any punch items',
    updatedDate: '2026-04-28', gcCustomerId: 'c7', jobLocation: 'Macon, GA',
    bidders: [],
    lastTouchAt: '2026-04-28T14:00:00Z',
  },
  {
    id: 'pr42', customerId: 'c2', name: 'Nair Design — small loft refresh', status: 'Won',
    description: 'Quick turn — 1,200 sqft engineered hardwood install for a designer client',
    address: '340 Ponce De Leon Ave, Atlanta, GA 30308',
    value: 9200, productIds: ['p3'], sampleOrderIds: [],
    notes: [],
    createdDate: '2026-04-14', anticipatedOrderDate: '2026-04-30', closingDate: '2026-04-30',
    invoicedDate: '2026-05-04', invoicedAmount: 9200,
    opportunityId: 'OPP-2026-0125', salesRepId: 'rep-sarah', salesLocationId: '310',
    projectType: 'single_family', opportunityStatus: 'won', opportunityStage: 'orders_placed',
    nextStep: 'Send Priya a thank-you note for the quick close',
    updatedDate: '2026-05-04', architecturalFirmId: 'c2', jobLocation: 'Atlanta, GA',
    bidders: [],
    lastTouchAt: '2026-05-04T13:00:00Z',
  },
  // Recently-created opportunities — show "Sales Created" activity for the week.
  {
    id: 'pr43', customerId: 'c8', name: 'Cumberland Mixed-Use Tower', status: 'Lead',
    description: 'Janet just routed a new spec to us — 24-story mixed-use, Cumberland district',
    address: '2920 Cobb Pkwy SE, Atlanta, GA 30339',
    value: 320000, productIds: ['p1', 'p4', 'p6'], sampleOrderIds: [],
    notes: [],
    createdDate: '2026-05-09', anticipatedOrderDate: '2027-03-01',
    opportunityId: 'OPP-2026-0151', salesRepId: 'rep-sarah', salesLocationId: '310',
    projectType: 'mixed_use', opportunityStatus: 'active', opportunityStage: 'lead_qualification',
    nextStep: 'Schedule spec meeting with Janet — confirm scope before bidding',
    updatedDate: '2026-05-09', architecturalFirmId: 'c8', jobLocation: 'Atlanta, GA',
    bidders: [],
    lastTouchAt: '2026-05-09T11:00:00Z',
  },
  {
    id: 'pr44', customerId: 'c11', name: 'Atlantic Capital — Atlanta Westside Mixed-Use', status: 'Lead',
    description: 'Just landed today — Atlantic Capital developing a new Westside mixed-use block',
    address: '1163 Howell Mill Rd NW, Atlanta, GA 30318',
    value: 245000, productIds: ['p1', 'p2', 'p4'], sampleOrderIds: [],
    notes: [],
    createdDate: '2026-05-12', anticipatedOrderDate: '2027-01-15',
    opportunityId: 'OPP-2026-0158', salesRepId: 'rep-sarah', salesLocationId: '310',
    projectType: 'mixed_use', opportunityStatus: 'active', opportunityStage: 'lead_qualification',
    nextStep: 'Architect TBD — confirm with Diana this week',
    updatedDate: '2026-05-12', developerCustomerId: 'c11', gcCustomerId: 'c11',
    jobLocation: 'Atlanta, GA',
    bidders: [],
    lastTouchAt: '2026-05-12T08:30:00Z',
  },
];
...
export const seedPresentations: Presentation[] = [
  {
    ...
    slides: [
      ...
      { id: 'slide-3', type: 'brochure', brochureId: 'b2', spotlightProductIds: ['p1', 'p8'], notes: 'Cross-reference COREtec — most customers know the brand, our equivalent is better priced.' },
      { id: 'slide-4', type: 'brochure', brochureId: 'b10', notes: 'Close on LEED — sustainability is the deciding factor on most public-sector specs.' },
    ],
  ...
  },
  {
    ...
    slides: [
      ...
      { id: 'slide-2', type: 'brochure', brochureId: 'b3', spotlightProductIds: ['p3', 'p7'], notes: 'Lookbook is the conversation starter — Peachtree Oak + MapleCrest both featured.' },
      { id: 'slide-3', type: 'brochure', brochureId: 'b8', notes: 'Mohawk TecWood — name-brand alternative if the designer specs by manufacturer.' },
    ],
  ...
  },
  {
    ...
    slides: [
      ...
      { id: 'slide-2', type: 'brochure', brochureId: 'b2', spotlightProductIds: ['p8'], notes: 'AquaShield LVT — glue-down, 6mil wear, easy clean. Antimicrobial spec on file if they ask.' },
      { id: 'slide-3', type: 'brochure', brochureId: 'b4', spotlightProductIds: ['p4'], notes: 'Daltile for wet areas and corridors. PEI 4 rating; large-format 24x24 reduces grout joints.' },
      { id: 'slide-4', type: 'brochure', brochureId: 'b6', notes: 'Commercial carpet for offices + waiting rooms — solution-dyed nylon, 28oz loop.' },
    ],
